...
Welcome to my central security notebook. This repository is where I keep all my notes, step-by-step guides, and lessons from my hands-on labs and coursework as I study cybersecurity and network infrastructure.
...
My notes are organized into domain-specific modules:

- **[`01-networking/`](./01-networking/)** — Fundamental networking, protocols, IP routing, and Cisco Packet Tracer network simulation labs.
- **[`02-linux/`](./02-linux/)** — Linux system administration, CLI navigation, process management, and user permissions via LabEx.
- **[`03-security-fundamentals/`](./03-security-fundamentals/)** — Offense vs. defense concepts, foundational security controls, and TryHackMe walkthroughs.

---

## 🎓 Learning Platforms & Sources

| Domain | Platform | Focus Areas |
| :--- | :--- | :--- |
